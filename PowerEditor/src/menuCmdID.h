...
#define    IDM_LANG    (IDM + 6000)
    ...
    #define    IDM_LANG_ASN1               (IDM_LANG + 59)
    #define    IDM_LANG_AVS                (IDM_LANG + 60)
    #define    IDM_LANG_BLITZBASIC         (IDM_LANG + 61)
    #define    IDM_LANG_PUREBASIC          (IDM_LANG + 62)
    #define    IDM_LANG_FREEBASIC          (IDM_LANG + 63)
    #define    IDM_LANG_CSOUND             (IDM_LANG + 64)
    #define    IDM_LANG_ERLANG             (IDM_LANG + 65)
    #define    IDM_LANG_ESCRIPT            (IDM_LANG + 66)
    #define    IDM_LANG_FORTH              (IDM_LANG + 67)
    #define    IDM_LANG_LATEX              (IDM_LANG + 68)
    #define    IDM_LANG_MMIXAL             (IDM_LANG + 69)
    #define    IDM_LANG_NIMROD             (IDM_LANG + 70)
    #define    IDM_LANG_NNCRONTAB          (IDM_LANG + 71)
    #define    IDM_LANG_OSCRIPT            (IDM_LANG + 72)
    #define    IDM_LANG_REBOL              (IDM_LANG + 73)
    #define    IDM_LANG_REGISTRY           (IDM_LANG + 74)
    #define    IDM_LANG_RUST               (IDM_LANG + 75)
    #define    IDM_LANG_SPICE              (IDM_LANG + 76)
    #define    IDM_LANG_TXT2TAGS           (IDM_LANG + 77)
